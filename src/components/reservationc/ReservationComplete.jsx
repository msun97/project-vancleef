  ...
  return (
    <div className="mb-[70px] w-full">
      ...
      {currentStep > 1 && location.boutiqueId && (
        <h3 className="border-t-2 font-secondary text-[20px] pt-[30px] pb-[20px]">
          예약 확인
        </h3>
      )}
      ...
      {currentStep > 1 && location.boutiqueId && (
        <div className="flex flex-col w-[560px] bg-gray-10 px-5 pb-5 mx-auto ">
          <span
            className="pt-5 text-[14px] text-gray-60"
      ...
      {reservation.status === 'pending' && (
        <div className="flex flex-col w-[560px] mx-auto mt-8">
          <div className="bg-gray-900 text-white text-center py-3 font-secondary">
            예약이 완료되었습니다
          </div>
        </div>
      )}
