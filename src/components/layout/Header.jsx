    ...
    return (
        ...
        >
            <div className='left flex items-center gap-[55px] z-[999]'>
                <Link to='/home'>
                    <h1>
                        <img src='/icons/logo.svg' alt='Van Cleef & Arpels' className='w-[340px]' />
                    </h1>
                </Link>
                <nav>
                    <ul className='flex gap-8'>
                        ...
                        <Link to='/kbrand'>
                            <li className='font-secondary text-heading-m font-bold'>EXHIBITION</li>
                        </Link>
                        <Link to='/customers/notice'>
                            <li className='font-secondary text-heading-m font-bold'>고객센터</li>
                        </Link>
                    </ul>
                </nav>
            </div>
