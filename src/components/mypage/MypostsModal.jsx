...
const MypostsModal = () => {
  ...
  return (
    <Draggable nodeRef={nodeRef} bounds="body" handle=".handle">
      <div ref={nodeRef} className="fixed min-w-[710px] min-h-[626px] z-[1000] mt-[80px] mx-auto bg-white p-[50px] rounded-md border border-black">
...
placeholder="내용"
						style={{ resize: 'none' }}
            className="w-full p-2 bg-[#F4F4F4] text-[#9C9C9C] focus:outline-none focus:ring-1 focus:ring-gray-200"
          />
        </div>
