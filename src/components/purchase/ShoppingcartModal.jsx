          ...
          <div className="w-full h-[600px] flex flex-col justify-between">
            <div className="relative flex">
              ...
              <div className="w-full my-[20px] ml-[10px]">
                <div className="w-full flex justify-between items-center">
                  ...
                  <button className="text-label-xs font-secondary color-gray-90">
                    삭제
                  </button>
                </div>
                <div className="text-content-xs mt-[9px]">상품명</div>
                <div className="text-content-xs mt-[2px]">상품금액</div>
                <div className="text-label-xs text-gray-50 font-secondary mt-[12px]">
                  스톤종류
                </div>
                <button className="text-content-xs underline color-gray-90">
                  옵션변경
                </button>
              </div>
            </div>
            ...
            <div>
              <div className="flex flex-col justify-between border-t border-[#666666]">
                ...
                <Button className={"w-full h-[55px] text-[17px] tracking-wide"}>
                  주문하기
                </Button>
              </div>
            </div>
