        ...
        <ul className="font-secondary font-bold">
          <li>
            ...
            <ul className="text-content-l leading-18">
              ...
              {isSubmenuVisible && (
                <ul className="submenu font-bold text-content-l leading-8 font-primary pl-3 text-shadow-lg cursor-pointer">
                  <li
                    id="Necklaces"
                    onClick={() => handleCategoryChange(1, "목걸이")}
                  >
                    Necklaces
                  </li>
                  <li
                    id="Bracelets"
                    onClick={() => handleCategoryChange(2, "팔찌")}
                  >
                    Bracelets
                  </li>
                  <li
                    id="Rings"
                    onClick={() => handleCategoryChange(3, "반지")}
                  >
                    Rings
                  </li>
                  <li
                    id="Earrings"
                    onClick={() => handleCategoryChange(4, "귀걸이")}
                  >
                    Earrings
                  </li>
                </ul>
