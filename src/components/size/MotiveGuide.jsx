            ...
            <div className="py-5 px-8">
                ...
                <div className="w-full flex justify-center gap-2">
                    <div className="border border-gray-300">
                        <img src="/images/size/sweet-1.PNG" alt="스위트알함브라" className="w-[250px] h-[205px]" />
                        <div>
                    ...
                    <div className="border border-gray-300">
                        <img src="/images/size/vintate-2.PNG" alt="스위트알함브라" className="w-[250px] h-[205px]" />
                        <div>
                            <div className="h-[220px] flex items-center justify-center">
                    ...
                    <div className="border border-gray-300">
                        <img src="/images/size/pure-3.PNG" alt="스위트알함브라" className="w-[250px] h-[205px]" />
                        <div>
                            <div className="h-[220px] flex items-center justify-center">
                    ...
                    <div className="border border-gray-300">
                        <img src="/images/size/magin-4.PNG" alt="스위트알함브라" className="w-[250px] h-[205px]" />
                        <div>
                            <div className="h-[220px] flex items-center justify-center">
