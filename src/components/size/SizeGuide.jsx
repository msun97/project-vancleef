                    ...
                    <div>
                        ...
                        <ol className="flex flex-col gap-3">
                            <li>
                                ...
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;확인하고 랜드스케이프 포맷이 선택되었는지 확인해주세요.
                            </li>
                            <li>2. 양식지 위에 손목 사이즈 측정 도구를 프린트하세요</li>
                            <li>3. 확실하지 않은 경우, 자를 이용해서 프린트된 길이를 재어보세요.</li>
                            <li>4. 손목 사이즈 측정 도구를 잘라낸 후 손목에 맞춰 보세요.</li>
                            <li>5. 손목에 딱 맞는 브레이슬릿 사이즈를 확인하시려면 첨부된 차트를 참조해주세요.</li>
                        </ol>
                        <div className="mt-[30px] text-[12px] text-gray-500">
                            사이즈 가이드는 참고 지표로서 제공됩니다. 고객님께 맞는 사이즈를 확인하시려면 반클리프 아펠
                            부티크에 방문하셔서 브레이슬릿을 직접 착용해보시길 추천해드립니다.
                        </div>
                    </div>
                </div>
