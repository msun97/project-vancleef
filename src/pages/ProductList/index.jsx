...
const ProductListPage = () => {
    ...
    return (
        <div className='w-full h-full relative bg-fixed bg-[url("/images/productListPageBg.png")] bg-no-repeat bg-top bg-cover'>
            <div className=" p-330 flex text-white font-secondary pt-[219px]">
                ...
                <div className="pb-12 w-[74%] pl-[40px] font-primary">
                            ...
                            <div>
                                ...
                                <ul className="hidden w-[128px] bg-white py-2.5 text-black leading-[2]">
                                    <li className="h-[33px] radio-label">
                                        <input type="radio" id="sort1" name="sort" value="" className="radio-custom" />
                        ...
                        <div>
                            <div className="productList pb-[30px]">
                                <div className="relative w-full">
                                    <div>
                                        <ul className="rellax relative w-full" data-rellax-speed="-3">
                                            <li className="transition-all duration-1000 ease-in-out top-0  bg-white p-[25px_30px_33px] w-[46.5%] min-h-[597px] mr-[7%]">
                                            ...
                                            <li className="transition-all duration-1000 ease-in-out top-0  bg-white p-[25px_30px_33px] w-[46.5%] min-h-[597px] mt-[40px] mr-[7%]">
                                                <div className="py-2.5 text-left text-[#1c1c1c]">
                                                    <div>
                                                        <a href="">
                                                            <img
