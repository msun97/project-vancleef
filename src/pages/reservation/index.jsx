...
const ReservationPage = () => {
  ...
  const reservationItem =
    JSON.parse(localStorage.getItem('reservationItem')) || {};
  ...
  useEffect(() => {
    ...
    if (storedReservation) {
      ...
      if (
        ...
        parsedReservation.status === 'confirmed'
      ) {
        ...
        if (
          parsedReservation.location &&
          parsedReservation.location.boutiqueId
        ) {
          step = 2;
        }
        ...
        if (
          ...
          (parsedReservation.purpose.productConsultation ||
            parsedReservation.purpose.repairService) &&
  ...
  return (
    <div className="pt-[80px] px-[545px] w-full">
      <h2 className="font-secondary font-bold text-[36px] text-center pb-[80px]">
        예약 요청
      </h2>
      {/* 예약 완료된 단계 표시 */}
      <ReservationComplete />
